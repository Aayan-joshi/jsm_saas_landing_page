...
const Header = () => {
  ...
  return (
    <header
      className={clsx(
        `fixed top-0 left-0 z-50 w-full py-10 transition-all duration-500 max-lg:py4`,
        hasScrolled && "py-2 bg-black-100 backdrop-blur-[8px]",
      )}
    >
      <div className={`container flex h-14 items-center max-lg:px-5`}>
        <a href="" className={`lg:hidden flex flex-1 cursor-pointer z-2`}>
          <img src="/images/xora.svg" alt="Logo" width={115} height={55} />
        </a>

        <div
          className={clsx(
            `w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:bg-s2 max-lg:opacity-0 transition-opacity duration-500`,
