    ...
    <section>
      <Element name="Pricing">
        <div className={`container`}>
          ...
          >
            <h3
              className={`h3 max-lg:h4 max-md:h5 z-3 relative mx-auto mb-14 text-center text-p4 max-w-lg max-md:mb-11 max-sm:max-w-sm`}
            >
              Flexible pricing of teams of all sizes
            </h3>

            <div
              className={`relative z-4 mx-auto flex w-[375px] rounded-3xl border-[3px] border-s3/25 bg-s1/50 p-2 backdrop-blur-[6px] max-md:w-[310px]`}
            >
              <button
          ...
          >
            {plans.map((plan, index) => (
              <div
                key={plan.id}
                className={`relative border-2 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%+2px)] p-7 pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even`}
              >
                {index === 1 && (
                  <div
                ...
                <ul className={`mx-auto space-y-4 xl:px-7`}>
                  {plan.features.map((feature) => (
                    ...
                    >
                      ...
                      />
                      <p className={`flex flex-1`}>{feature}</p>
                    </li>
                  ))}
                </ul>
